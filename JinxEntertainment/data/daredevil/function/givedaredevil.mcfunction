...
execute positioned as @s run summon skeleton_horse ~ ~ ~ {Health:16f,Tame:1b,attributes:[{id:"minecraft:generic.jump_strength",base:1.2},{id:"minecraft:generic.max_health",base:16},{id:"minecraft:generic.movement_speed",base:0.50},{id:"minecraft:generic.safe_fall_distance",base:100}],SaddleItem:{id:"minecraft:saddle"}}
