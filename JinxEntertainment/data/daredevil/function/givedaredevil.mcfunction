...
execute positioned as @s run summon skeleton_horse ~ ~ ~ {Health:14f,Tame:1b,attributes:[{id:"minecraft:generic.jump_strength",base:1.5},{id:"minecraft:generic.max_health",base:14},{id:"minecraft:generic.movement_speed",base:1},{id:"minecraft:generic.safe_fall_distance",base:100}],SaddleItem:{id:"minecraft:saddle"}}
