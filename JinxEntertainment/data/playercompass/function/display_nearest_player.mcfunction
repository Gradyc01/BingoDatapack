...
execute positioned as @s[team=TeamNone] run title @s actionbar [{"color":"aqua","selector":"@p[distance=1..,gamemode=!spectator]"},{"text":" is "},{"score":{"name":"@s","objective":"calculateDistanceTotal"}},{"text":" blocks away"}]
