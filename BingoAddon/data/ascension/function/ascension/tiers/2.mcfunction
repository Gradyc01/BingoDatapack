...
attribute @s generic.armor modifier add asc_2 -0.2 add_multiplied_base
attribute @s generic.attack_damage modifier add asc_2 -0.03 add_multiplied_base
attribute @s generic.attack_speed modifier add asc_2 -0.05 add_multiplied_base
