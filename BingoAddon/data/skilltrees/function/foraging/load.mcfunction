...
data modify storage skilltrees:foraging 2 set value ["Sweet Berries", "Egg", "+ Light Apple", "+ Golden Head"]
...
data modify storage skilltrees:textlines skilltrees:foraging set value [0, 6, 4, 6, 3, 2]
