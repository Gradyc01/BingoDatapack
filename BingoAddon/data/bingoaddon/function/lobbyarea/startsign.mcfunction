...
item replace entity @s hotbar.8 with oak_sign[custom_name='{"bold":true,"color":"red","italic":false,"text":"Location Score Check"}',block_entity_data={id:"minecraft:oak_sign",front_text:{messages:['{"text":""}','{"text":"[Click Here]","color":"red","bold":true,"clickEvent":{"action":"run_command","value":"/function bingoaddon:locationchecker/check"}}','{"text":""}','{"text":""}']}}] 1
gamemode creative @s
