...
setblock ~-3 ~102 ~18 oak_wall_sign[facing=north]{front_text:{messages:['{"text":""}','{"text":"JE","color":"gold","bold":true}','{"text":"Recipes","color":"gold","bold":true,"clickEvent":{"action":"run_command","value":"/function bingoaddon:lobbyarea/viewrecipes/show_je"}}','{"text":""}']}} replace
setblock ~-1 ~102 ~18 oak_wall_sign[facing=north]{front_text:{messages:['{"text":""}','{"text":"Duplication","color":"gold","bold":true}','{"text":"Recipes","color":"gold","bold":true,"clickEvent":{"action":"run_command","value":"/function bingoaddon:lobbyarea/viewrecipes/show_duplication"}}','{"text":""}']}} replace
setblock ~1 ~102 ~18 oak_wall_sign[facing=north]{front_text:{messages:['{"text":""}','{"text":"Ability","color":"gold","bold":true}','{"text":"Recipes","color":"gold","bold":true,"clickEvent":{"action":"run_command","value":"/function bingoaddon:lobbyarea/viewrecipes/show_ability"}}','{"text":""}']}} replace
setblock ~3 ~102 ~18 oak_wall_sign[facing=north]{front_text:{messages:['{"text":""}','{"text":"Standard","color":"gold","bold":true}','{"text":"Recipes","color":"gold","bold":true,"clickEvent":{"action":"run_command","value":"/function bingoaddon:lobbyarea/viewrecipes/show_standard"}}','{"text":""}']}} replace
