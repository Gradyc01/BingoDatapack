...
scoreboard players set souls booleans 0
scoreboard players set deathPenalty booleans 0
...
function bingoaddon:lobbyarea/viewgamesetting/_gametype {text:"Brawl", color:"red", time:"TBD"}