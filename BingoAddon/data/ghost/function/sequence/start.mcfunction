...
execute store result score @s ghostX run data get entity @s Pos[0]
execute store result score @s ghostY run data get entity @s Pos[1]
execute store result score @s ghostZ run data get entity @s Pos[2]
