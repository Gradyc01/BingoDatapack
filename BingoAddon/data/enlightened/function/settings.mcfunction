...
execute if score enableEnlightened booleans matches 1 run tellraw @a [{"color":"gold","text":"[Bingo Settings]"},{"color":"aqua","text":" Ascension"},{"color":"aqua", "text":" has now been enabled"}]
execute if score enableEnlightened booleans matches 0 run tellraw @a [{"color":"gold","text":"[Bingo Settings]"},{"color":"aqua","text":" Ascension"},{"color":"aqua", "text":" has now been disabled"}]
