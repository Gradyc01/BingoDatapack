...
summon lightning_bolt ~-5 ~ ~-5
summon lightning_bolt ~5 ~ ~-5
summon wither ~ 255 ~ {Tags:["wither"],CustomName:'{"bold":true,"color":"yellow","text":"Enlightened"}',Glowing:1b,DeathLootTable:"enlightened:nothing",Health:450f,Invul:1200,attributes:[{id:"minecraft:generic.max_health",base:450}],PersistenceRequired:0b}
