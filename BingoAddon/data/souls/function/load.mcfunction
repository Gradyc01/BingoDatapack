...
data modify storage skilltrees:souls 1 set value ["+ Backpack", "+ Vorpal Sword", "+ Quick Bow"]
...
data modify storage skilltrees:souls 4 set value ["Nether Star", "+ Cube Converter", "+ Dread", "+ Explosive Propulsion", "+ Crimson Artifact", "+ A Weaver\\'s Silk"]
data modify storage skilltrees:souls 5 set value ["Nether Star x2", "+ Wings Of Icarus", "+ Book Of Thoth", "+ Resurrection", "+ Daredevil"]
data modify storage skilltrees:textlines skilltrees:souls set value [0, 3, 3, 4, 6, 5]
