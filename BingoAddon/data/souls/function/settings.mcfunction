...
execute if score souls booleans matches 1 run tellraw @a [{"color":"gold","text":"[Bingo Settings]"},{"color":"aqua","text":" Skill Trees"},{"color":"aqua", "text":" has now been enabled"}]
execute if score souls booleans matches 0 run tellraw @a [{"color":"gold","text":"[Bingo Settings]"},{"color":"aqua","text":" Skill Trees"},{"color":"aqua", "text":" has now been disabled"}]
